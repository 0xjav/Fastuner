...
class TestDatasetValidator:
    ...
    def test_valid_dataset(self):
        ...
        records = DatasetValidator.validate_jsonl(jsonl)
    ...
    def test_missing_input_text(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            DatasetValidator.validate_jsonl(jsonl)

        assert "missing required field 'input_text'" in str(exc_info.value).lower()
    ...
    def test_missing_target_text(self):
        ...
        assert "missing required field 'target_text'" in str(exc_info.value).lower()
    ...
    def test_empty_input_text(self):
        ...
        assert "input_text cannot be empty" in str(exc_info.value).lower()
    ...
    def test_empty_target_text(self):
        ...
        assert "target_text cannot be empty" in str(exc_info.value).lower()
    ...
    def test_input_too_long(self):
        ...
        assert "input_text exceeds maximum length" in str(exc_info.value).lower()
    ...
    def test_target_too_long(self):
        ...
        assert "target_text exceeds maximum length" in str(exc_info.value).lower()
    ...
    def test_minimum_samples_check(self):
        ...
        assert "minimum 100 unique samples required" in str(exc_info.value).lower()
